...
public class Main {
  ...
  public static void main(String args[]) throws IOException {
    //long t1 = System.currentTimeMillis(); //Comment later
    ...
    //long tottime = (System.currentTimeMillis() - t1); //Comment later
    //System.out.println("CPU time: " + tottime + " ms"); //Comment later
